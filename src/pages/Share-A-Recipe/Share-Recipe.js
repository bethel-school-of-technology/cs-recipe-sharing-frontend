    ...
    axios.get(url + "/api/recipe/" + editId).then((res) => {
      if (res.status === 200) {
        if (res.data.authorId === currentUser.id) {
          ...
          if (res.data.servingSize) {
            setServing(res.data.servingSize);
          }
          if (res.data.cookTime) {
          ...
          if (res.data.image) {
            document.getElementById("imagePreview").src = res.data.image;
          }
          ...
          <form>
            <div className="recipeFormContainer">
              ...
              <div className="row2">
                ...
                >
                  {recipeId > 0 ? "Update Your Recipe!" : "Share Your Recipe!"}
                </button>
                {recipeId > 0 ? (
